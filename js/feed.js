...
var FALLBACK_NEWS = [
  ...
  {title:'After so many near-misses, Arsenal finally get it ...',src:'ESPN FC',cat:'FOOTBALL',link:'https://www.espn.com/soccer/story/_/id/48817408/arsenal-beat-manchester-city-win-premier-league-title-many-misses',date:'May 19'},
  ...
  for (var i = 0; i < MASTER_CHANNELS.length; i++) {
    ...
    try {
      ...
      for (var j = 0; j < items.length; j++) {
        ...
        var fp = fingerprint(title);
        seenExact[title.toLowerCase().replace(/\W+/,'')] = true;
        seenStories.push({
